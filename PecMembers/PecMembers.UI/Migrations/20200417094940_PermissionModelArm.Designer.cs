...
namespace PecMembers.UI.Migrations
{
    ...
    [Migration("20200417094940_PermissionModelArm")]
    partial class PermissionModelArm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PecMembers.UI.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PecMembers.UI.Data.PecMemberModels.PecMembersCurrent", b =>
                {
                    ...
                    b.ToTable("PecMembersCurrentDb");
                });

            modelBuilder.Entity("PecMembers.UI.Data.Permissions.PermissionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PecMembers.UI.Data.ApplicationUser", null)
                        .WithMany()
